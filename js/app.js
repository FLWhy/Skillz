...
ScrollReveal().reveal('.txt_column', {
    delay: 200
}, );
ScrollReveal().reveal('.img_column', {
    delay: 200
}, );
ScrollReveal().reveal('.second_row', {
    delay: 200
}, );
ScrollReveal().reveal('.third_row', {
    delay: 200
}, );
ScrollReveal().reveal('.forth_row', {
    delay: 200
}, );
ScrollReveal().reveal('.workshop', {
    delay: 200
}, );
ScrollReveal().reveal('.upcoming-workshop', {
    delay: 200
}, );
ScrollReveal().reveal('.workshop_squares', {
    delay: 200
}, );
ScrollReveal().reveal('.feedback_stars', {
    delay: 200
}, );
ScrollReveal().reveal('.about_container', {
    delay: 200
}, );
ScrollReveal().reveal('.feedback_txt', {
    delay: 200
}, );
ScrollReveal().reveal('.blog_txt', {
    delay: 200
}, );
ScrollReveal().reveal('.blog_squares', {
    delay: 200
}, );
ScrollReveal().reveal('.faq_header', {
    delay: 200
}, );
ScrollReveal().reveal('#faq-row1', {
    delay: 200
}, );
ScrollReveal().reveal('#faq-row2', {
    delay: 200
}, );
ScrollReveal().reveal('#faq-row3', {
    delay: 200
}, );
ScrollReveal().reveal('#faq-row4', {
    delay: 200
}, );
ScrollReveal().reveal('#faq-row5', {
    delay: 200
}, );
ScrollReveal().reveal('#faq-row1', {
    delay: 200
...
ScrollReveal().reveal('.link_columns', {
    delay: 200
}, );
...
btn.onclick = () =>{
  burger_menu.classList.toggle('burger_menu-active')
